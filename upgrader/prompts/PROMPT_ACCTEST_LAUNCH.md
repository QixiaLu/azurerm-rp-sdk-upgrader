...
to `python -m upgrader.helpers`. This turn only LAUNCHES the suite detached and EXITS — never wait
for results, never edit code, never git commit/push/checkout.
